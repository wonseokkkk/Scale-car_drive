...
//    namedWindow("USB_CAM");
//    moveWindow("USB_CAM", 710, 700);

//    if(!prev_img.empty()) {
//      resize(prev_img, prev_img, Size(640, 480));
//      imshow("USB_CAM", prev_img);
//      waitKey(2);
//    }
}
...
float LaneDetector::display_img(Mat _frame, int _delay, bool _view) {		
  Mat new_frame, gray_frame, binary_frame, diff_frame, sliding_frame, resized_frame;
